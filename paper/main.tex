...
\end{equation}
For any initially discontinuous gauge, the unitary that smoothens the gauge will also itself be discontinous, making $\partial_{\mu} U$ ill-defined. 
...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=3.4in]{paper/ssh_berry_conn.png}
\end{center}
% \centering
\vspace{-7.5mm}
\caption{
...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=3.4in]{paper/fkm_axion_angle_comparison.png}
\end{center}
% \centering
\vspace{-7.5mm}
...
In contrast to the analytic single-point construction, the finite-difference connection exhibits enhanced sensitivity in the vicinity of the topological obstruction, as visible in Fig.~\ref{fig:1}. In this regime, the overlap matrices exhibit small singular values, and extracting the unitary part via polar decomposition becomes numerically delicate. As a result, the logarithm of $\mathcal{U}_\mu$ can fluctuate appreciably on coarse meshes, even when $\mathcal{T}$-breaking trial states are employed.

This behavior reflects the fact that the finite-difference approach discretizes the Berry connection itself through neighboring-point overlaps, thereby introducing additional discretization error prior to the evaluation of the Chern--Simons integral. By contrast, the single-point formulation provides an exact expression for the non-Abelian Berry connection at each $k$-point; the only remaining approximation arises from the Riemann-sum evaluation of the Brillouin-zone integral.

\begin{figure}[t!]
\begin{center}
\includegraphics[width=3.4in]{paper/fkm_axion_angle_convergence.png}
\end{center}
% \centering
\vspace{-7.5mm}
\caption{
...
\acknowledgments
%=================================================
This work was supported by NSF Grant DMR-2421895. We thank Andrea Urru and Daniel Seleznev for useful discussions in relation to this work.
